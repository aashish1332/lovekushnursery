export const API_BASE = import.meta.env.VITE_API_URL || (import.meta.env.PROD ? 'https://lovekushnursery-api.vercel.app' : (typeof window !== 'undefined' ? '' : 'http://localhost:3001'))
